...
void z8cwiz3()
{
    ll typ1, typ2, typ3, typ4;
    cin >> typ1 >> typ2 >> typ3 >> typ4;
    if (typ1 == 0)
    {
        CE(1);
        return;
    }
    ll typ23 = min(typ2, typ3);
    ll typ234 = abs(typ2 - typ3) + typ4;
    ll typ1234 = min(typ1 + 1, typ234);
    ll res_cnt = typ1 + typ23 + typ23 + typ1234;
    CE(res_cnt);
}
